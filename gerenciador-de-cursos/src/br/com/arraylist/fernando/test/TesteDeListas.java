...
public class TesteDeListas {
	...
	public static void main(String[] args) {
		...
		System.out.println("Inserção na ArrayList demorou  " + tempoArrayList + " milissegundos!");
		System.out.println("Inserção na LinkedList demorou " + tempoLinkedList + " milissegundos!");

		tempoArrayList = removePrimeirosElementos(numerosArrayList);
		tempoLinkedList = removePrimeirosElementos(numerosLinkedList);

		System.out.println("Remoção da ArrayList demorou  " + tempoArrayList + " milissegundos!");
		System.out.println("Remoção da LinkedList demorou " + tempoLinkedList + " milissegundos!");
	}
